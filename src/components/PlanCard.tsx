...
const PlanCard = ({description,price,time,title}:PlanTypes) => {
  return (
    // <div className="w-full max-w-sm p-[2px] rounded-xl bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
      <div className="bg-[#1e1e1e]  rounded-xl p-6 flex flex-col gap-4 max-w-[600px]">
        ...
        <div className="flex gap-3 pt-4 text-sm">
          <button className=" px-4 py-2 bg-dark  rounded-md hover:bg-black  transition">
            Start Free Trial
          </button>
